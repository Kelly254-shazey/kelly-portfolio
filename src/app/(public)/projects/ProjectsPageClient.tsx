    ...
    <div className="min-h-screen pt-24 pb-16">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="mb-12">
          ...
          <p className="mt-4 text-lg text-gray-400">Explore my work and side projects.</p>
        </motion.div>
          ...
          >
            {filtered.map((project, index) => (
              <motion.div
                ...
                className="group relative overflow-hidden rounded-2xl border border-white/5 bg-dark-200/50 p-6 transition-all duration-300 hover:border-primary-500/30 hover:shadow-xl"
              >
