      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-4">
            {researchPapers.map((paper, index) => (
              <motion.div
                ...
                className="glass-card p-5 flex items-start justify-between gap-4 group hover:border-primary-500/30 transition-all"
              >
                <div className="flex-1">
                  <h3 className="text-white font-semibold mb-1 group-hover:text-primary-400 transition-colors">{paper.title}</h3>
                  <p className="text-sm text-gray-500">{paper.venue} &middot; {paper.year}</p>
                </div>
        ...
        <div>
          <div className="flex items-center gap-3 mb-8">
            ...
            <h2 className="text-2xl font-bold text-white">Vision Documents</h2>
          </div>
          <Card className="p-8 text-center">
            <BookOpen className="mx-auto h-12 w-12 text-gray-600 mb-4" />
            <h3 className="text-lg font-semibold text-white mb-2">The Future of Intelligent Systems</h3>
            ...
            <button className="inline-flex items-center gap-1 text-sm text-primary-400 hover:text-primary-300 transition-colors">
