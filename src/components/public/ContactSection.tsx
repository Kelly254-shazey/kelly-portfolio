...
export function ContactSection() {
  ...
  return (
    <section id="contact" className="relative py-16 sm:py-20 lg:py-28 bg-light-50 dark:bg-dark-100/50 overflow-hidden">
          ...
          <div className="grid gap-8 lg:grid-cols-3">
            ...
            {[
              ...
              { icon: MapPin, label: 'Location', value: 'Nairobi, Kenya' },
                ...
                <div key={item.label} className="flex items-center gap-4 glass-card hover-lift p-4">
                  <div className="rounded-xl bg-primary-500/10 p-3 text-primary-600 dark:text-primary-400">
