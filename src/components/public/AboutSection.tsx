        ...
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {roles.map((role, index) => (
            <motion.div
              ...
              className="glass-card group p-6 hover:border-primary-500/30 transition-all duration-300"
            >
              <div className="mb-4 inline-flex rounded-xl bg-primary-500/10 p-3 text-primary-400 group-hover:scale-110 transition-transform">
